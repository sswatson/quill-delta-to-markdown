...
// test('renders bold format', async function() {
...
// test('renders italic format', async function () {
//   const md = await render({})([
//     {
//       insert: 'Hi ',
//     },
...
// test('renders block format', async function() {
//   expect(
//     await render({})([
//       {
//         insert: 'Headline',
...
test('renders lists with inline formats correctly', async function() {
  expect(
    await render({})([
      {
        attributes: {
...
// test('render an inline link', async function() {
//   expect(
//     await render({})([
//       {
//         insert: 'Go to Google',
...
// test('renders todo block', async function() {
//   expect(
//     await render({})([
//       {
//         insert: 'First todo',
